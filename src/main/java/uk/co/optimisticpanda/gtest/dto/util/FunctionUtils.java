...
public class FunctionUtils {
	...
	/**
	 * A value generator instance that is used as a null object, it does not
	 * generate anything and throws an {@link UnsupportedOperationException} if
	 * {@link #generate()} is called.
	 */
	public static final Supplier<?> NOT_COVERED = new Supplier<Object>() {
		@Override
		public Object get() {
