...
/**
 * This is a base class that {@link IEdit}s can extend to provide property
 * access support.
 * 
 * @param <D>
 ...
 * @author Andy Lee
 */
public abstract class AbstractEdit<D> extends PropertyAccessSupport implements IEdit<D> {
	 ...
	 */
	public AbstractEdit(Object context) {
		super(context);
	}
